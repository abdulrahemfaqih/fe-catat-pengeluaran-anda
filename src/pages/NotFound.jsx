...
const NotFound = () => {
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-gray-50">
            <div className="relative overflow-hidden rounded-xl border-4 border-black bg-yellow-100 p-6 md:p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] w-full max-w-lg mx-auto transform -rotate-1">
                {/* Decorative elements */}
                ...
                <div className="text-center">
                    <div className="inline-flex items-center justify-center w-24 h-24 bg-white rounded-full border-4 border-black shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] mb-6">
                        <span className="text-5xl">🔍</span>
                    </div>

                    <h1 className="text-4xl font-bold mb-2 relative inline-block">
                        404
                        <span className="absolute -bottom-1 left-0 w-full h-3 bg-red-200 -z-10"></span>
                    </h1>

                    <h2 className="text-2xl font-bold mb-6 relative inline-block mx-auto">
                        Halaman Tidak Ditemukan!
                        <span className="absolute -bottom-1 left-0 w-full h-3 bg-yellow-200 -z-10"></span>
                    </h2>

                    <div className="bg-white border-3 border-black rounded-xl p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] mb-6 max-w-md mx-auto">

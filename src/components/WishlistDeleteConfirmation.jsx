      ...
      >
         ...
         >
            ...
            <div className="flex items-center gap-3 mb-4">
               ...
               <h3 className="text-xl font-bold dark:text-white transition-colors duration-300">Hapus Wishlist</h3>
            </div>
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/40 border-3 border-black rounded-lg p-3 mb-4 transition-colors duration-300">
               ...
               {wishlistItem && (
                  <div className="mt-3 bg-white dark:bg-gray-700 border-3 border-black rounded-lg p-3 flex flex-col gap-2 transition-colors duration-300">
                     <div className="flex items-center justify-between border-b-2 border-dashed border-black/20 dark:border-white/20 pb-2 transition-colors duration-300">
                        <span className="font-bold dark:text-white transition-colors duration-300">Nama:</span>
                        <span className="font-bold text-lg dark:text-white transition-colors duration-300">
                           {wishlistItem.name}
                        </span>
                     </div>
                     <div className="flex items-center justify-between">
                        <span className="font-medium dark:text-white transition-colors duration-300">Harga:</span>
                        <span className="font-bold dark:text-white transition-colors duration-300">

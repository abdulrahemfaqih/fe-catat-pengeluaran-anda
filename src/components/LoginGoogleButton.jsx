...
const GoogleLoginButton = ({ onClick }) => {
  return (
    ...
    type="button"
      onClick={onClick}
      className="w-full mt-3 flex items-center justify-center gap-3 border-3 border-black bg-white py-3 rounded-lg font-bold hover:bg-gray-50 transition shadow-[5px_5px_0px_rgba(0,0,0,1)]"
    >
